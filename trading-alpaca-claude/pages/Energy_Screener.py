#!/usr/bin/env python3
"""
Energy Companies Breakout Screener — standalone Streamlit page
...
with c2:
    if st.button("🔄 Refresh", use_container_width=True):
        run_energy_scan.clear()
        st.rerun()

with st.spinner("Scanning 30 energy companies..."):
    rows = run_energy_scan()
...
groups = {
    "🛢️ Majors":        ["XOM","CVX","COP","OXY"],
    "⛏️ E&P":           ["EOG","DVN","FANG","MRO","APA","CTRA"],
    "🔧 Oil Services":  ["SLB","HAL","BKR"],
    "🔗 Midstream":     ["ET","WMB","KMI","EPD","TRGP"],
    "🏭 Refining":      ["VLO","PSX","MPC"],
    "💡 Utilities":     ["NEE","DUK","SO","AEP","EXC"],
    "☀️ Clean Energy":  ["ENPH","FSLR","PLUG","BE"],
}
for col, (label, tickers) in zip([c1, c2, c3, c4, c5, c6, c7], groups.items()):
