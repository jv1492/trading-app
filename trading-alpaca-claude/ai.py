#!/usr/bin/env python3
"""
AI Companies Breakout Screener
Run: python3 ai.py

Scores ~30 AI-focused stocks using the same criteria as the dashboard:
...
def main():
    print(f"\n{'='*65}")
    print(f"  AI Companies Breakout Screener — {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print(f"  Scoring {len(AI_UNIVERSE)} tickers · Same criteria as dashboard")
    print(f"{'='*65}")
    print("  Fetching data...")
